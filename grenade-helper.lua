...
local v93 = (function()
    ...
    pcall(ffi.cdef, [[
        typedef int(__thiscall* get_clip_count_t)(void*);
        typedef void(__thiscall* set_clip_text_t)(void*, const char*, int);
        typedef int(__thiscall* get_clip_text_t)(void*, int, const char*, int);
    ]])
    local get_count = utils.get_vfunc('vgui2.dll', 'VGUI_System010', 7, 'get_clip_count_t')
    local set_text = utils.get_vfunc('vgui2.dll', 'VGUI_System010', 9, 'set_clip_text_t')
    local get_text = utils.get_vfunc('vgui2.dll', 'VGUI_System010', 11, 'get_clip_text_t')

    return {
        get = function()
            local len = get_count()
            if len > 0 then
                local buf = char_array(len)
                get_text(0, buf, len)
                return ffi.string(buf, len - 1)
            end
        end,
        set = function(txt) set_text(tostring(txt), #tostring(txt)) end
    }
end)()
...
do
    ...
    do
        ...
        local function v399()
            ...
            if l_l_get_alpha_0_0 == nil or l_l_get_style_0_0 == nil or l_globals_0 == nil or l_l_sidebar_0_0 == nil then
                return;
            end;
...
do
    ...
    local function v418()
        ...
        if l_get_0 == nil or l_l_map_patterns_0_0 == nil then
            return;
        end;
        ...
        if v415 == nil then
            ...
            if l_l_map_patterns_0_0.current_map_pattern then
    ...
    local function v419()
        ...
        if l_globals_0 == nil or l_write_0 == nil then
            return;
        end;
        if not l_globals_0.is_in_game then
            v297 = nil;
            if l_write_0 and l_write_0.call then
                return l_write_0:call();
            end;
            return;
        else
            if l_v410_0 == nil or l_get_map_data_0 == nil then
                return;
            end;
            v297 = l_v410_0[v298];
            if v297 ~= nil then
                ...
                local v_map_data = l_get_map_data_0();
                if v_map_data == nil then
                    return;
                end;
                v297 = l_lower_0(v_map_data.shortname);
    ...
    local function v427()
        ...
        if l_v409_0 == nil or l_l_map_patterns_1_0 == nil or l_l_map_patterns_0_0 == nil then
            return;
        end;
        l_v410_0 = {};
        ...
        if l_l_map_patterns_0_0.selection then
            l_l_map_patterns_0_0.selection:update(v422);
        end;
        if l_l_map_patterns_0_0.on_visibility then
    ...
    l_l_map_patterns_0_0.save:set_callback(function()
        ...
        if v298 == nil or l_v409_0 == nil or l_l_map_patterns_0_0 == nil or v271 == nil or v272 == nil then
            return;
        end;
        if l_v409_0[v298] ~= nil then
    ...
    l_l_map_patterns_0_0.delete:set_callback(function()
        ...
        if l_l_map_patterns_0_0 == nil or l_l_map_patterns_1_0 == nil or v271 == nil or v272 == nil then
            return;
        end;
...
do
    ...
    do
        ...
        v484 = function()
            -- upvalues: v85 (ref), l_v485_5 (ref), l_gsub_0 (ref), v271 (ref), v252 (ref), l_l_v486_4_1 (ref), l_format_0 (ref), v272 (ref), l_v482_3 (ref), l_decode_0 (ref), v86 (ref), l_execute_after_0 (ref)
            ...
            local v_new_index = #l_locations_8 + 1;
            l_locations_8[v_new_index] = {
                name = l_v1072_0, 
                locations = {}
            };
            v272(v1073);
            l_v482_3(v1073);
            if l_decode_0 and l_decode_0.locations and l_decode_0.locations.selection then
                v86(l_decode_0.locations.selection, v_new_index);
                l_execute_after_0(0.01, function()
                    -- upvalues: l_decode_0 (ref), v_new_index (ref), v85 (ref)
                    if l_decode_0 and l_decode_0.locations and l_decode_0.locations.selection and l_decode_0.locations.edit and l_decode_0.locations.edit.call then
                        local v_sel = v85(l_decode_0.locations.selection);
                        if v_sel == v_new_index then
                            l_decode_0.locations.edit:call();
                        end;
                    end;
                end);
            end;
    ...
    do
        ...
        l_v489_3 = function(v1137)
            ...
            if l_l_v490_2_2 == nil or v271 == nil or v86 == nil then
                return;
            end;
            local v1138 = v85(l_l_v490_2_2);
            if v1138 == nil or v1138 <= 0 then
                return;
            end;
            ...
            if l_locations_11 == nil or l_locations_11[v1138] == nil then
                return;
            end;
            v1139 = nil;
            v438 = true;
            v439 = {
                ...
                source_index = v1138, 
                enabled = l_active_locations_1 and l_active_locations_1[v1138] or false
            };
            if l_l_locations_selection_0_0 then
