    ...
    local general = { } do
        ...
        local recommendations = { } do
            ...
            groups.recommendations:label("Links") do
                groups.recommendations:button(
                    merge(get_space(2), "\aD71E21FF", icons.get "youtube", "\aDEFAULT", get_space(3), "YouTube", get_space(1), "##LINK_1"), create_link("https://dsc.gg/southwestcfgs"), true
                ):tooltip("Youtube Channel")

                groups.recommendations:button(
                    merge(get_space(2), "\a5662F6FF", icons.get "discord", "\aDEFAULT", get_space(3), "Discord", get_space(1), "##LINK_2"), create_link("https://dsc.gg/southwestcfgs"), true
