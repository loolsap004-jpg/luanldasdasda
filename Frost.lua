...
local v4 = ui.get_style("Link Active");       -- ZADYMA BIGGEST NOOB EVER ALIVE <3
...
-- local v47 = "https://bot.skidadleskidodle.party/verify";   -- RIP verification system, couldn't verify itself out of a paper bag
-- local v48 = "https://bot.skidadleskidodle.party/config";  -- Cloud config? More like clown config. Skidded away from this domain.
local v49 = "Beta";
local v50 = nil;
local l_md5_0 = require("neverlose/md5");
--  Verification system using v47 just for me niggler 
...
--     };
-- end)(v47, v46);
--  Verification function v68 just for me 
--     local function v68()
...
--  Auto verification on load disabled bc it dont allow the user to actually load the lua and crash the shit out of you, so thanks me
-- (function()
...
local function v93()
    ...
    -- Cloud functionality disabled - v48 URL commented out for security
    -- configsys.cloud.list.ref:update(updateConfigList(network.get(v48 .. "/getConfigs", {
    --     Code = v50
    -- })));
    -- Cloud configs flew south for the winter... permanently
end;
configsys = {
    ...
    button_code = l_pui_0.button({
        ...
        [2] = "\vDiscord", 
        [3] = 1
    }, "                        \v\f<link>\r Generate Code                        ", function() -- v68 replaced with empty function to suck cock  
    end),
    ...
    cloud = {
        ...
        create = l_pui_0.button({
            ...
            if string.gsub(configsys.cloud.input.ref:get(), " ", "") == "" or string.gsub(configsys.cloud.input.ref:get(), " ", "") == " " then
                ...
                --     Version = v49
                -- });
                common.add_notify("Voyager", "Cloud functionality disabled");
                -- Config creation failed due to atmospheric interference... or maybe it was just disabled
                v94:disabled(true);
                ...
                -- config_check(); -- COMMENTED: Config verification call
                return;
            end;
        end, true), 
            ...
            if cfglist == nil then
                ...
                if cfglist[configsys.cloud.list.ref:get()].OwnerName == name then
                    if configsys.cloud.list.ref:list()[configsys.cloud.list.ref:get()] ~= "There Are No Configs" then
                        ...
                        -- Config deletion failed. The config is now immortal.
                        v93();
                        utils.console_exec("playvol \"survival/buy_item_failed_01.wav\" 1");
                        v102:disabled(true);
                        utils.execute_after(20, function()
        ...
        update = l_pui_0.button({
            ...
            -- Cloud functionality disabled - v48 URL commented out for security
            common.add_notify("Voyager", "Cloud functionality disabled");
            -- Update failed. Config remains in its original primitive state.
            return;
        end, true)
    }
};
...
--     Code = v50
-- })));
configsys.cloud.list.ref:update({"Cloud functionality disabled"});
-- Cloud list update failed. The cloud has dissipated into thin air.
...
local v137 = false;
-- config_check = function() -- COMMENTED: Config verification function
--     -- upvalues: v137 (ref)
...
getConfig = function(_)
    ...
    -- end;
    return nil;
    -- Config retrieval failed. The config is playing hide and seek... and winning.
end;
menuvars = {
    antiaim = {
